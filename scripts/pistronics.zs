...
recipes.addShaped(<Pistronics2:Rod Block> * 8, [[<ore:woodLumber>], [<ore:ingotIron>], [<ore:woodLumber>]]);
...
recipes.addShapeless(<Pistronics2:Camou Paste>, [<terrafirmacraftplus:item.dyePowder:1>, <terrafirmacraftplus:item.dyePowder:4>, <terrafirmacraftplus:item.dyePowder:11>, <terrafirmacraftplus:item.dyePowder:2>]);
